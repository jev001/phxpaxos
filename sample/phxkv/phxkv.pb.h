...
class KVOperator : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:phxkv.KVOperator) */ {
 public:
  KVOperator();
  virtual ~KVOperator();
...
class KVData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:phxkv.KVData) */ {
 public:
  KVData();
  virtual ~KVData();
...
class KVResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:phxkv.KVResponse) */ {
 public:
  KVResponse();
  virtual ~KVResponse();
